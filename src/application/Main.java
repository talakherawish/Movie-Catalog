...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		ImageView backgroundImage = new ImageView(new Image("file:src/images/movieHome.png"));
	...
	private void openMovieCatalogPage(Stage primaryStage) {
		ImageView backgroundImage = new ImageView(new Image("file:src/images/cinema.png"));
		backgroundImage.setFitWidth(1366);
		backgroundImage.setFitHeight(768);
		backgroundImage.setPreserveRatio(true);
...
//			movieMenu.getSelectionModel().clearSelection();
	...
	private void openAddMovieStage() {
		...
		ImageView backgroundImage = new ImageView(new Image("file:src/images/add.png"));
